...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark border-botton
    border-body" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href=""> Gerenciador de Tarefas</a>
            <button class="navbar-toggler" type="button" data-bs-toggles="collapse" data-bs-target="#navbarNavAltMarkup"
